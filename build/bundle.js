var app = (function () {
    ...
    /* src\Space.svelte generated by Svelte v3.35.0 */
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			t = text(/*space*/ ctx[0]);
    			attr(div, "class", "space svelte-48uhz0");
    ...
    function create_if_block_1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(button, "class", "svelte-ga6lge");
    		},
    		m(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(p, "class", "errorMessage svelte-ga6lge");
    		},
    		m(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "row svelte-ga6lge");
    			attr(div1, "class", "row svelte-ga6lge");
    			attr(div2, "class", "row svelte-ga6lge");
    			attr(main, "class", "svelte-ga6lge");
    		},
    		m(target, anchor) {
